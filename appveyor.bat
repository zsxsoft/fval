...
mkdir ..\pecl\php-eval-detection
xcopy .\src ..\pecl\php-eval-detection
cmd /c buildconf
...
curl -L -k -o %PHP_RELEASE_PATH%\phpunit.phar https://phar.phpunit.de/phpunit-5.7.phar || goto :error
cd %~dp0php\tests
